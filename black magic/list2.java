...
import java.io.*;
class list2 extends Frame
{
    Label head,bot;
    Button ch;
    static String ar[]={"","One","Two","Three","Four","Five","Six","Seven","Eight","Nine","Ten","Eleven","Twelve","Thirteen","Fourteen","Fifteen","Sixteen","Seventeen","Eighteen","Nineteen","Twenty",};
    ...
    public list2()
    {
        ...
        head=new Label("List of numbers",Label.CENTER);
        ...
        for(int i=1;i<=20;i++)
        {
            int d=ck.get(i-1);
            if(i<=10)
            print(50,130+(i*35),200,35,Color.white,(char)(i+64)+"."+ar[d],20);
            if(i>10)
            print(280,130+((i-10)*35),200,35,Color.white,(char)(i+64)+"."+ar[d],20);
        }
    ...
    class ButtonHandler1 implements ActionListener
    {
        public void actionPerformed(ActionEvent e)
        {
            try
            {
                ...
                if(arg.equals("Begin"))
                {
                    for(int i=16,c=5;i>=1;i/=2,c--)
                    {
                        round r=new round(c+get(i),"num:char");
                        r.main(c+get(i),"num:char");
                        setVisible(false);    
                    }                    
                }
            }
